...
import os
from f_extract_surface_patch_padded import *
...
for mutant_name in mutants:
    ...
    pos, adj, w, x = extract_surface_patch_padded(predcoords, center_index, 12, features, padding = 1300)

    # Compress adj and W to sparse representations
    ...
    os.chdir("C:\\Users\\david\\MT_data\\extracted_patches\\mutant_graphs_padded")
